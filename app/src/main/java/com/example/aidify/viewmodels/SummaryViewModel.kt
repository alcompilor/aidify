...
class SummaryViewModel(private val dataViewModel: DataViewModel) : ViewModel() {
    ...
    fun getFeedback(): String? = dataViewModel.state.value.result.summary.feedback

    fun getDiagnosis(): String? = dataViewModel.state.value.result.summary.assessment

    fun getRiskOfAbuse(): String? = dataViewModel.state.value.result.summary.abuseRisk
    ...
    fun generatePdf(context: Context) {
        ...
        val fileName = "Aidify_Summary_${System.currentTimeMillis()}.pdf"  // Timestamp added for uniqueness
